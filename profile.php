...
<aside class="sidebar" id="sidebar">
    <ul><i class="fas fa-bars" id="menu-toggle1"></i>
    ...
    <li class="books"><i class="fas fa-book"></i> Browse Books</li>
    <li class="books1"><i class="fas fa-folder-open"></i> Categories</li>
    <li class="home1"><i class="fas fa-trophy"></i> Best Sellers</li>
...
<!--Background -->
<div class="top-bg">
    <img src="light bg.png" class="bg-img"></img>
</div>
...
<div class="profile-container">
    ...
    <label for="file-input" id="edit-icon"><i class="fas fa-pencil-alt"></i></label>
